  ...
  data() {
    return {
      ...
      menuItems: [
        ...
        { id: 'datasources', title: 'Datasources', link: '/datasources', icon: 'mdi-database' },
        { id: 'charts', title: 'Charts', link: '/charts', icon: 'pie_chart' },
        { id: 'dashboards', title: 'Dashboards', link: '/dashboards', icon: 'dashboard' },
        {
          id: 'observability',
